...
atividade = Atividade("Redação", "04/10/2018", "Fazer um Redação do ENEM", disciplina, ["testando", "oi"], "15")
        ...
        if len(self.usuarios) == 0:
            ...
            for usuario in self.usuarios:
                if email == usuario.get_email():
                    ...
                    print(self.mudar_cor("Email e/ou Senha Incorretas", 31))

    # _________________________________________________________________________
    #     METODOS SOBRE ATIVIDADE

    def criar_atividade(self, nome, data_final, conteudo, disciplina, tags, id, usuario):
        disciplina.adicionar_atividade(Atividade(nome, data_final, conteudo, disciplina, tags, id))
        ...
        if opcao2 == '1':
            ...
            if disciplina != None:
                ...
                if self.buscar_atividade(id, usuario) == None:
                    ...
                    self.criar_atividade(nome, data_final, conteudo, disciplina, tags, id, usuario)
                else:
            ...
            if opcao4 == '1':
                ...
                if opcao3 == '1':
                    ...
                    teste = self.buscar_usuario(email)
                    if teste == None:
                ...
                if atividade != None:
                    ...
                    if opcao3 == '5':
                        novo = input("Tags da atividade(separadas por virgula): ").split(',')
                        atividade.set.tags(novo)
