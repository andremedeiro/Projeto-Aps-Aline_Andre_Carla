...
#     METODOS SOBRE ATIVIDADE
    ...
    def criar_atividade(self, nome, data_final, disciplina, tags, id, usuario):
        disciplina.adicionar_atividade(Atividade(nome, data_final, disciplina, tags, id))
...
#                        MENUS
    ...
    def menu_logado(self, usuario):
        ...
        print("6 - Remover Atividade")
        print("7 - Concluir Atividade")
        print('x - Sair')
        ...
        if opcao2 == '1':
            ...
            if disciplina != None:
                ...
                if self.buscar_atividade(id,usuario) == None:
                    ...
                    tags=input("Tags da atividade(separadas por virgula): ").split(',')
                    self.criar_atividade(nome, data_final, disciplina, tags, id, usuario)
                else:
            ...
            atividade_excluir = self.buscar_atividade(id, usuario)
            if atividade_excluir != None:
                print("A Atividade " + str(atividade_excluir.get_nome()) + " Foi Excluida com Sucesso")
                self.remover_atividade(atividade_excluir, usuario)
            else:
                print("Atividade Não Existente")

        elif opcao2 == '7':
            id = input("Informe o ID da Atividade: ")
            atividade = self.buscar_atividade(id, usuario)
            if atividade != None:
                print("A Atividade " + str(atividade.get_nome()) + " Foi Concluida com Sucesso")
