...
class Usuario:
    ...
    def listar_disciplinas(self):
        print(mudar_cor("Disciplinas:", 34))
        for disciplina in self.disciplinas:
            print(" ")
            print(mudar_cor(disciplina,34))
    ...
    def listar_atividades(self):
        ...
        if len(atividades) == 0:
            print(mudar_cor("Nenhuma Atividade Cadastrada", 31))
        else:
